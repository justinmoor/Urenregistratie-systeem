...
public class InvullenUrenView extends Scene {
            ...
            private void InitAction() {
                ...
                bevestig.setOnAction(e -> {
                    if (klantField.getLength() > 1 && projectField.getLength() > 1 && onderwerpField.getLength() > 1 && !BeginDatum.getValue().equals("") && !BeginTijd.getText().equals("") && !EindDatum.getValue().equals("") && !EindTijd.getText().equals("") && BeginDatum.getValue().isBefore(EindDatum.getValue()) || BeginDatum.getValue().equals(EindDatum.getValue())) {
                        ...
                        if (bestaandeKlant != true) {
                            ...
                            MeldingView view = new MeldingView("Klanten", controller.getDb(), klantField.getText(), projectField.getText(), onderwerpField.getText(), this);
                            view.setString("wilt u deze klant: '" + klantField.getText() + "' en het bijbehorende project: '" + projectField.getText() + "' en onderwerp: '" + onderwerpField.getText() + "' toevoegen?");
               ...
               //             }
                            ...
                            MeldingView view = new MeldingView("projecten", controller.getDb(), klantField.getText(), projectField.getText(), onderwerpField.getText(), this);
                            view.setString("wilt u dit project: '" + projectField.getText() + "' en onderwerp: '" + onderwerpField.getText() + "' toevoegen?");
                            /*
                            Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                            ...
                            MeldingView view = new MeldingView("Klanten", controller.getDb(), klantField.getText(), projectField.getText(), onderwerpField.getText(), this);
                            view.setString("wilt u dit onderwerp: '" + onderwerpField.getText() + "' toevoegen?");
